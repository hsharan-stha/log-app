...
@section('content')
    <div class="d-flex justify-content-between align-items-center mb-4">
        <div>
            ...
            <p class="text-muted mb-0">Only one kiosk can be active. An admin must revoke it before another tablet can register.</p>
        </div>
    </div>
    <div class="card border-0 shadow-sm">
        <table class="table mb-0 align-middle">
            <thead class="table-light">
            <tr><th>Name</th><th>Location</th><th>Token</th><th>Registered by</th><th>Last seen</th><th>Status</th><th></th></tr>
            </thead>
            <tbody>
